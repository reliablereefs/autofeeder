...
pub fn ntp_request(client: &std::net::UdpSocket, server: &str) -> anyhow::Result<u64> {
...
pub fn ntp_sync() -> anyhow::Result<()> {
    let client = std::net::UdpSocket::bind("0.0.0.0:0")?;
